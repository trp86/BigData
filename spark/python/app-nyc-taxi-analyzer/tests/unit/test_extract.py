...
def test_true_condition_extract_csv_file(spark_session_test: SparkSession):
    ...
    # ACT
    actual_df = extract.extract_csv_file(spark_session_test, test_extract_csv_file_location)
...
@pytest.mark.extract_csv_file
def test_exception_if_file_path_doesnot_exist(spark_session_test: SparkSession):
    # ASSEMBLE
